...
(autothemer-deftheme
 ...
 ((default                                   (:background gruvbox-bg :foreground gruvbox-light0))
  ...
  (org-level-3                               (:foreground gruvbox-faded_blue))
  (org-level-4                               (:foreground gruvbox-neutral_orange))
  (org-level-5                               (:foreground gruvbox-neutral_blue))
  (org-level-6                               (:foreground gruvbox-neutral_purple))
  (org-level-7                               (:foreground gruvbox-neutral_aqua))
  (org-level-8                               (:foreground gruvbox-neutral_green))
